...
msfragger.fragment_ion_series=y
msfragger.fragment_mass_tolerance=0.3
...
msfragger.precursor_mass_lower=-1.5
msfragger.precursor_mass_mode=isolated
msfragger.precursor_mass_units=0
msfragger.precursor_mass_upper=1.5
msfragger.precursor_true_tolerance=1
...
msfragger.table.var-mods=15.9949,M,true,2; 42.0106,[^,true,1; 79.96633,STY,false,3; -17.0265,nQnC,false,1; -18.0106,nE,false,1; 4.025107,K,false,2; 6.020129,R,false,2; 8.014199,K,false,2; 10.008269,R,false,2; 0.0,site_10,false,1; 0.0,site_11,false,1; 0.0,site_12,false,1; 0.0,site_13,false,1; 0.0,site_14,false,1; 0.0,site_15,false,1; 0.0,site_16,false,1
...
workflow.description=Workflow for Stellar data (unit resolution in MS1 and MS2) acquired in DDA mode. Enabling Koina models in MSBooster (Validation tab; off by default) is recommended. Can also be used for GPFDIA data, however, Stellar-GFPDIA workflow may give better results. If using this workflow, annotate files as 'GPF-DIA' type. Adjust the precursor tolerance (MSFragger tab) to +- isolation window*1.5. E.g., set +-3 Da precursor tolerance for DIA data aquired using a 2 Th window. Different fragment tolerances may be investigated as well (default 0.3 Da).
