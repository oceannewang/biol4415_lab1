...
workflow.description=Perform database searching for wide-window acquisition (WWA) data, followed by label free quantification with match-between-runs using IonQuant. Need to set the "data type" to DDA+.
