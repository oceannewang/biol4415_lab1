...
msfragger.table.var-mods=15.9949,M,true,2; 42.0106,[^,true,1; 79.96633,STY,false,2; 4.025107,K,true,3; 6.020129,R,true,3; 8.014199,K,true,3; 10.008269,R,true,3; 0.0,site_8,false,1; 0.0,site_9,false,1; 0.0,site_10,false,1; 0.0,site_11,false,1; 0.0,site_12,false,1; 0.0,site_13,false,1; 0.0,site_14,false,1; 0.0,site_15,false,1; 0.0,site_16,false,1
...
ptmprophet.cmdline=NOSTACK KEEPOLD STATIC FRAGPPMTOL\=10 EM\=1 NIONS\=b STY\:79.966331,n\:42.0106,M\:15.9949,K\:4.025107,K\:8.014199,R\:6.020129,R\:10.008269 MINPROB\=0.5
...
ptmshepherd.diagmine_fragMinPropensity=00
...
ptmshepherd.run_diagmine_mode=true
...
workflow.description=Triple-SILAC quantification workflow. Closed search with MSFragger, SILAC quantification with IonQuant. Note\: If the dataset has multiple MS files (e.g. replicates or LC fractions) they should be annotated as different experiments (e.g. F1, F2, etc. in the Experiment column).
