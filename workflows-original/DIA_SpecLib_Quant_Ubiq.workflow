...
msfragger.table.var-mods=15.9949,M,true,1; 42.0106,[^,true,1; 79.96633,STY,false,2; -17.0265,nQnC,false,1; -18.0106,nE,false,1; 114.04293,K,true,1; 0.0,site_07,false,1; 0.0,site_08,false,1; 0.0,site_09,false,1; 0.0,site_10,false,1; 0.0,site_11,false,1; 0.0,site_12,false,1; 0.0,site_13,false,1; 0.0,site_14,false,1; 0.0,site_15,false,1; 0.0,site_16,false,1
...
workflow.description=DIA workflow for ubiquitination data. Peptides are identified directly from DIA data (runs labelled as \u2018DIA\u2019 or \u2018DIA-Lib\u2019) using MSFragger-DIA search. Oxidation, N-term Acetyl and lysine ubiquitination are specified as variable modifications, with up to 2 missed cleavages allowed. PSM rescoring with MSBooster and validation with Percolator, followed by site localization with PTM-Prophet, and protein inference with ProteinProphet. Spectral library is built using EasyPQP, with data filtered to 1% FDR at the PSM, peptide, and protein levels. DIA-NN is used to extract quantification from each run annotated as \u2018DIA\u2019 using that library. PTM-Prophet localization information is propagated to the DIA-NN output files, which are then further processed to generate site-level reports.
