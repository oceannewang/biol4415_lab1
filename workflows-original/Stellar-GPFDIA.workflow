...
msfragger.precursor_mass_lower=-3
msfragger.precursor_mass_mode=selected
msfragger.precursor_mass_units=0
msfragger.precursor_mass_upper=3
...
workflow.description=Workflow for Stellar data (unit resolution in MS1 and MS2) acquired in GPF-DIA mode. Enabling Koina models in MSBooster (Validation tab; off by default) is recommended. Different fragment tolerances may be investigated as well (default 0.3 Da). Note that GPFDIA data may also be searched as DDA data (see Stellar-DDA workflow), however, Stellar-GFPDIA workflow may give better results.
