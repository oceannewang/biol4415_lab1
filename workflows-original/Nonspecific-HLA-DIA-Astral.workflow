# Workflow: Nonspecific-HLA-DIA-Astral
...
msfragger.misc.fragger.precursor-charge-hi=3
...
msfragger.table.var-mods=15.9949,M,true,1; 42.0106,[^,true,1; 79.96633,STY,false,3; -17.0265,nQnC,false,1; -18.0106,nE,false,1; 119.0041,C,true,1; 0.0,site_07,false,1; 0.0,site_08,false,1; 0.0,site_09,false,1; 0.0,site_10,false,1; 0.0,site_11,false,1; 0.0,site_12,false,1; 0.0,site_13,false,1; 0.0,site_14,false,1; 0.0,site_15,false,1; 0.0,site_16,false,1
...
workflow.description=<p style\="margin-top\: 0in">Workflow for quantitative HLA type I peptidome profiling using Astral narrow window DIA. Supports DDA-based (when DDA data is available), direct Astral DIA-based, and hybrid (from both DIA and DDA) spectral library building. Narrow window DIA files are searched directly using MSFragger-DIA. Nonspecific search, peptide length 7-15, cysteines assumed to be not alkylated (i.e. samples were not treated with iodoacetamide). Cysteinylation (C+119) is specified as a variable modification. Deep learning-based rescoring of MSFragger results with MSBooster, followed by PSM validation with Percolator. Protein inference is performed with ProteinProphet but protein FDR filter is not applied, so each output file (PSM, ion, peptide) is filtered to 1% FDR at that level. Spectral library building with EasyPQP (the library is filtered to 1% peptide-level FDR) followed by quantification, using that library, from the DIA files using DIA-NN.</p>\n<p style\="margin-top\: 0in"></p> Notes\: for HLA type II peptides, increase max peptide length to 20 or 25. If samples were alkylated, specify C+57 as fixed and C+61.98264 as variable modification (Cysteinylation).
